...
public class UdfIsinteger extends UDF<INTEGER> {

	private static final long serialVersionUID = 1L;

	public Class valideParameterType(Class[] params) throws SemanticException {
		if (params.length != 1) {
			throw new SemanticException("Function(udf_isinteger) should have two parameters");
		}
	...
	public static INTEGER evaluate(Object[] args) {
		...
		try {
			INTEGER res = CastUtil.toInteger(o);
			if (res == null) {
				return new INTEGER(0);
			} else
