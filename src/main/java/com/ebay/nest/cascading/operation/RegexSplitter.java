...
/**
 * Class RegexSplitter will split an incoming argument value by the given regex
 * delimiter patternString.
 */
public class RegexSplitter extends RegexOperation<Pair<Pattern, Tuple>>
	...
	/**
	 * Constructor RegexOperation creates a new RegexOperation instance, where
	...
	public void prepare(FlowProcess flowProcess,
		...
		operationCall.setContext(new Pair<Pattern, Tuple>(getPattern(),
				new Tuple()));
	}
	...
	public void operate(FlowProcess flowProcess,
		...
		String[] split = functionCall.getContext().getLhs()
				.split(value, length);
